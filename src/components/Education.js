  ...
  return (
    <div className="contents md:hidden">
      ...
      >
        ...
        <h3 className="leading-tight text-justify mb-2 text-lg font-semibold lg:text-base">
          {title}
        </h3>
  ...
  return (
    <div className={` contents ${isSmall ? "hidden" : ""}`}>
      ...
      <motion.div
        ...
        transition={{ duration: 0.5, type: "easy" }}
        className={`bg-light col-start-1 col-end-5 p-4 py-2 rounded-xl  ml-auto shadow-md flex flex-col border-b-4
    								border-${colorIcon}-600 w-[400px] lg:w-[300px] md:w-[400px] sm:w-[300px] xs:w-[270px] md:col-start-2 md:col-end-4  `}
      >
        <div className="flex items-center justify-between text-sm mb-2">
          <span>{company}</span>
          <span>{date}</span>
  ...
  return (
    <div className="contents  ">
      ...
      <motion.div
        ...
        border-${colorIcon}-600 w-[400px] lg:w-[300px] md:w-[400px] sm:w-[300px] xs:w-[270px]`}
      >
        <div className="flex items-center justify-between text-sm mb-2">
          <span>{company}</span>
          <span>{date}</span>
...
const Education = () => {
  ...
  return (
    <>
      <h2 className="text-8xl text-center py-36 lg:text-6xl  sm:text-5xl   lg:py-28 xd:py-8 font-semibold">
        {t("education")}
      </h2>

      <div
        ref={ref}
        className="relative grid grid-cols-9 gap-6 md:gap-4 md:grid-cols-6  mb-16 "
      >
        <motion.div
