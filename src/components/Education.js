...
const LeftBox = ({ company, date, title, author, colorIcon = "purple", childIcon = "U" }) => {
	return (
    <div
    ...
    border-${colorIcon}-600 w-[400px] `}
      ...
      <div className='xs:col-start-1 xs:col-end-2 md:col-start-5 md:col-end-6 sm:mx-0 md:mx-auto relative mr-10'>
        ...
        <div className={`w-12 h-12 absolute left-0 -translate-x-[50%]  md:left-[50%] border-4 border-double  border-light top-1/2 -mt-3 rounded-full bg-${colorIcon}-600 shadw-2xl flex items-center justify-center text-light font-bold text-2xl `}>
          {childIcon}
        </div>
      </div>
    </div>
...
const RightBox = ({company, date, title, author, colorIcon = "purple", childIcon = "U"}) => {
	return (
    <div className='contents '>
					<div className='col-start-5 col-end-6 mr-10 md:mx-auto relative'>
						<div className='h-full w-6 flex items-center justify-center'></div>
						<div className={`w-12 h-12 absolute left-0 -translate-x-[50%] md:left-[50%] border-4 border-double border-light top-1/2 -mt-3 rounded-full  bg-${colorIcon}-600 shadow-2xl flex items-center justify-center text-light font-bold text-2xl`}>
							{childIcon}
						</div>
					</div>
					<motion.div 		initial={{ x: 140 }}
	...
	return (
       ...
       <LeftBox company='Udemy' date="2021-05-12" title="Bootstrap Od Podstaw - Stwórz 4 Wyjątkowe strony WWW!" author="Mateusz Maj"  />
        ...
        <LeftBox company='Udemy' date="2021-05-30" title="10 projektów w czystym JavaScript" author="Mateusz Maj"   />
				<RightBox company='teach:able' date="2021-07-30" title="Kurs Tworzenia Stron WWW cz. 3"  author="Mateusz Maj" colorIcon='green' childIcon='t'  />
       <LeftBox company='teach:able' date="2021-09-11" title="Kurs Tworzenia Stron WWW cz. 4" author="Mateusz Maj" colorIcon='green'  childIcon='t' />
       ...
       <LeftBox company='tech:able' date="2022-01-12" title="15 zaawansowanych komponentów na strony WWW!" author="Mateusz Maj" colorIcon='green'  childIcon='t'  />
