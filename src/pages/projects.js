		...
		return (
			<div className='relative rounded-2xl  flex items-center jusify-center group'>
							<div className='flex items-center justify-center relative flex-col  '>
								<Image className='w-[90%] ' src={image} alt={alt} />
	...
	return (
		<>
			<Head>
				...
				<meta name="description" content="Welcome to Sebastian Nowak's portfolio website. Explore my projects and skills in web development, graphic design, and more." />
			...
			<main className='w-full mb-16 flex flex-col items-center justify-center'>
				...
				<div className='mx-4 grid grid-cols-4   gap-y-24 '>
					<div className='col-span-2'>
						<WebProject image={projectCasting} alt='Casting project page' hrefToPage='https://casting-appv1.onrender.com/' gitLink='https://github.com/sporthq/castingmern'  />
						 </div>
						
					<div className='col-span-2 '>
					<WebProject image={projectForest} alt='Forest project page' hrefToPage='https://sporthq.github.io/forest/' gitLink='https://github.com/sporthq/forest'  />
					</div>
					<div className='col-span-2 '><WebProject image={projectMapty} alt='Mapty project page' hrefToPage='https://mapty-tbq2.onrender.com/' gitLink='https://github.com/sporthq/mapty'  /></div>
					<div className='col-span-2 '><WebProject image={projectForkify} alt='Forkify project page' hrefToPage='https://forkify-sporthq.netlify.app/' gitLink='https://github.com/sporthq/forkify'  /></div>
					<div className='col-span-4 col-start-2  '><WebProject image={projectBankist} alt='Bankist project page' hrefToPage='https://bankist-71x0.onrender.com/' gitLink='https://github.com/sporthq/bankist'  /></div>
